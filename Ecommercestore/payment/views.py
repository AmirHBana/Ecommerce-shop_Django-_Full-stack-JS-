...
def checkout(request):
    ...
    # User's with account -- pre-fill the form
...
def complete_order(request):
    ...
    if request.POST.get('action') == 'post':
        ...
        '''
             ...
             1) Create order -> Account user's with and without shipping information
             
             2) Create order -> Guest user's without an account
...
def payment_success(request):
    ...
    # Clear shopping cart when order complete
